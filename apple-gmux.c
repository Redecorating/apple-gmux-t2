...
static void gmux_read_switch_state(struct apple_gmux_data *gmux_data)
{
	...
	if (gmux_read8(gmux_data, GMUX_PORT_SWITCH_DISPLAY) == 4) //TODO: this was 2, is it a T2 thing that 4 is the number now?
...
static const struct apple_gmux_type apple_gmux_pio = {
	...
	.gmux_handler = &gmux_handler_classic,
...
static const struct apple_gmux_type apple_gmux_index = {
	...
	.gmux_handler = &gmux_handler_indexed,
